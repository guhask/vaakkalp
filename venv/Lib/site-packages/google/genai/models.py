...
class Models(_api_module.BaseModule):
  ...
  def generate_content(
    ...
    - The Gemini model ID, for example: 'gemini-2.5-flash-lite'
    - The full resource name starts with 'projects/', for example:
      'projects/my-project-id/locations/us-central1/publishers/google/models/gemini-2.5-flash-lite'
    - The partial resource name with 'publishers/', for example:
      'publishers/google/models/gemini-2.5-flash-lite' or
  ...
  def list(
    ...
    .. code-block:: python
      ...
      print(response.page)
      # [Model(name='publishers/google/models/gemini-2.5-flash-lite-exp' ...
    """
